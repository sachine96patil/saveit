...
<div class="container">
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <h2 class="text-center" style=" color:darkred;">GEOGRAPHY</h2>
    </div>
  </div>
...
?>
  ...
  <div class="row text-center">         
        Enter the title to be searched for:<br/>
         <form action ="geography.php" method = post>
...
$q1="SELECT Title1,User1 FROM geography WHERE Match(Title1) Against ('$value')";
